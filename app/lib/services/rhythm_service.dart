...
class RhythmService {
  ...
  static const MethodChannel _methodChannel = MethodChannel('cc.lxii.player/rhythm_method');
  static const EventChannel _eventChannel = EventChannel('cc.lxii.player/rhythm_event');
