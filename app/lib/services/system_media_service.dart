...
class SystemMediaService {
  ...
  LxAudioHandler? _audioHandler;  // Android 媒体处理器
    ...
    try {
      ...
      _audioHandler = await AudioService.init(
        ...
        config: AudioServiceConfig(
          androidNotificationChannelId: 'cc.lxii.player.channel.audio',
          androidNotificationChannelName: 'LxPlayer',
      ...
      if (_audioHandler != null) {
        ...
        if (Platform.isAndroid) {
          print('   通知渠道 ID: cc.lxii.player.channel.audio');
          print('   ⚠️ 如果通知未显示，请检查：');
