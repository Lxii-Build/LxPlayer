...
import 'package:lxplayer/layouts/fluent_main_layout.dart';
import 'package:lxplayer/layouts/main_layout.dart';
import 'package:lxplayer/services/android_floating_lyric_service.dart';
import 'package:lxplayer/services/announcement_service.dart';
import 'package:lxplayer/services/auto_update_service.dart';
import 'package:lxplayer/services/cache_service.dart';
import 'package:lxplayer/services/developer_mode_service.dart';
import 'package:lxplayer/services/desktop_lyric_service.dart';
import 'package:lxplayer/services/listening_stats_service.dart';
import 'package:lxplayer/services/lyric_style_service.dart';
import 'package:lxplayer/services/lyric_font_service.dart';
import 'package:lxplayer/services/persistent_storage_service.dart';
import 'package:lxplayer/services/player_background_service.dart';
import 'package:lxplayer/services/player_service.dart';
import 'package:lxplayer/services/notification_service.dart';
import 'package:lxplayer/services/playback_resume_service.dart';
import 'package:lxplayer/services/permission_service.dart';
import 'package:lxplayer/services/system_media_service.dart';
import 'package:lxplayer/services/tray_service.dart';
import 'package:lxplayer/services/url_service.dart';
import 'package:lxplayer/services/audio_source_service.dart';
import 'package:lxplayer/services/auth_service.dart';
import 'package:lxplayer/services/version_service.dart';
import 'package:lxplayer/services/mini_player_window_service.dart';
import 'package:lxplayer/services/local_library_service.dart';
import 'package:lxplayer/pages/mini_player_window_page.dart';
import 'package:lxplayer/utils/theme_manager.dart';
import 'package:lxplayer/services/startup_logger.dart';
import 'package:flutter_acrylic/flutter_acrylic.dart';
import 'package:media_kit/media_kit.dart';
import 'package:lxplayer/pages/settings_page/audio_source_settings.dart';
import 'package:lxplayer/pages/mobile_setup_page.dart';
import 'package:lxplayer/pages/mobile_app_gate.dart';
import 'package:lxplayer/pages/desktop_app_gate.dart';

// 条件导入 flutter_displaymode（仅 Android）
import 'package:flutter_displaymode/flutter_displaymode.dart' if (dart.library.html) '';

Future<void> main() async {
  final startupLogger = StartupLogger.bootstrapSync(appName: 'LxPlayer');
  ...
  await runZonedGuarded(() async {
    ...
    if (Platform.isWindows || Platform.isMacOS || Platform.isLinux) {
      try {
        const channel = MethodChannel('cc.lxii.player/refresh_rate');
      ...
      await timed('windowManager.waitUntilReadyToShow', () async {
        windowManager.waitUntilReadyToShow(windowOptions, () async {
          ...
          await timed('windowManager.setTitle', () async {
            await windowManager.setTitle('LxPlayer');
          });
