...
int APIENTRY wWinMain(_In_ HINSTANCE instance, _In_opt_ HINSTANCE prev,
  ...
  const wchar_t kUniqueMutexName[] = L"Local\\LxPlayerInstanceMutex";
  ...
  // 格式: 公司名.应用名.子产品.版本号
  ::SetCurrentProcessExplicitAppUserModelID(L"LxPlayer.MusicPlayer.Desktop.1");
  ...
  if (!window.Create(L"lxplayer", origin, size)) {
    return EXIT_FAILURE;
  }
